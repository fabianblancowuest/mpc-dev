<%@ Page Title="Recuperacion de Lote dado de baja" Language="VB" MaintainScrollPositionOnPostback="true"
    MasterPageFile="~/master/p.master" AutoEventWireup="false" CodeFile="loteVentaRecuperacionBaja.aspx.vb"
    Inherits="Administracion_loteVentaRecuperacionBaja" %>

    <asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    </asp:Content>
    <asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
        <h1 class="titulo-rol">
            <asp:Label ID="Label1" runat="server" Text="Relocalización de Lote">
            </asp:Label>
        </h1>
        <!-- Selecciones -->
        <div class="lote-venta-liberacion-select">
            <asp:Panel ID="PanelUltimasRelocalizaciones" runat="server">
                <div class="text-center">
                    <asp:Label ID="Label11" runat="server" Text="Últimas Bajas" Visible="true"
                        CssClass="subtitulo-rol"></asp:Label>
                    <asp:Button ID="obutNuevaRelocalizacion" runat="server" Text="Nueva Recuperación"
                        CssClass="btn btn-basic btn-success m-3" />
                </div>

                <div class="contenedor-responsive">
                    <asp:SqlDataSource ID="odsloteVentaUltimasRelocalizaciones" runat="server"
                        ConnectionString="<%$ ConnectionStrings:STRSYSTEM %>"
                        SelectCommand="recuperacionLotesDadosDeBajaRPT" SelectCommandType="StoredProcedure">
                    </asp:SqlDataSource>
                    <asp:GridView ID="ogvloteVentaUltimasRelocalizaciones" runat="server" AllowSorting="True"
                        ...
                        DataSourceID="odsloteVentaUltimasRelocalizaciones" Font-Size="Small" DataKeyNames="idLoteVenta,idBarrio,Barrio,Manzana,lote,Fecha de Visita,Apellido y nombres del cliente,Fecha Liberacion">
                        <Columns>
                            <asp:CommandField ShowSelectButton="True" />
                            <asp:BoundField DataField="idLoteVenta" HeaderText="idLoteVenta" InsertVisible="False" ReadOnly="True" SortExpression="idLoteVenta" />
                            ...
                            <asp:BoundField DataField="Manzana" HeaderText="Manzana"
                                SortExpression="Manzana" />
                            <asp:BoundField DataField="lote" HeaderText="lote" SortExpression="lote" />
                            <asp:BoundField DataField="Fecha de Visita" HeaderText="Fecha de Visita"
                                SortExpression="Fecha de Visita" />
                            <asp:BoundField DataField="Apellido y nombres del cliente" HeaderText="Apellido y nombres del cliente"
                                SortExpression="Apellido y nombres del cliente" ReadOnly="True" />
                            <asp:BoundField DataField="Fecha Liberacion" HeaderText="Fecha Liberacion"
                                SortExpression="Fecha Liberacion" />
                        </Columns>
                    </asp:GridView>
                </div>
            </asp:Panel>
            <asp:Panel ID="PanelNuevaRelocalizacion" runat="server" Visible="false">
                ...
                <asp:Panel ID="PanelOrigen" runat="server" Visible="false">
                    <h4>
                        <asp:Label ID="Label6" runat="server" Text="ORIGEN - Venta a Relocalizar - Identifique Venta "
                    ...
                    <div>
                        ...
                        <asp:DropDownList ID="oddlBARRIOLOTEOperador" runat="server"
                            ...
                            DataValueField="idLoteVenta" CssClass="form-control" AutoPostBack="True">
                        </asp:DropDownList>
                    ...
                    <div>
                        ...
                        <asp:Label ID="olblIDLoteVenta" runat="server" Text="No seleccionada" Font-Bold="true">
                        </asp:Label>
                    </div>
                </asp:Panel>
                ...
                <asp:Panel ID="PanelDestino" runat="server" Visible="false">
                    <h4>
                        ...
                        <asp:Label ID="Label7" runat="server"
                            Text="DESTINO - Seleccione lote destino al que asignar la venta." Font-Bold="true">
                        </asp:Label>
                    </h4>
                    ...
                    <div>
                        <asp:SqlDataSource ID="odsBarrioHabilitadoManzanaReubica" runat="server"
                            ConnectionString="<%$ ConnectionStrings:STRSYSTEM %>"
                            SelectCommand="barrioHabilitadoManzanaSelecciona" SelectCommandType="StoredProcedure">
                            <SelectParameters>
                                <asp:ControlParameter ControlID="oddlBarrioHabilitadoSelecciona" Name="idBarrio"
                        ...
                        <asp:DropDownList ID="oddlBarrioHabilitadoManzanaReubica" runat="server" AutoPostBack="True"
                            DataSourceID="odsBarrioHabilitadoManzanaSelecciona" DataTextField="barrioManzanaDescripcion"
                            DataValueField="idBarrioManzana" Width="100%"></asp:DropDownList>
                    ...
                    <div>
                        ...
                        <asp:SqlDataSource ID="odsbarrioManzanaLoteReubica" runat="server"
                            ...
                            <SelectParameters>
                                ...
                                <asp:ControlParameter ControlID="oddlBarrioHabilitadoSelecciona"
                                    PropertyName="SelectedValue" Name="idBarrio" Type="Int32"></asp:ControlParameter>
                                <asp:ControlParameter ControlID="oddlBarrioHabilitadoManzanaReubica"
                                    PropertyName="SelectedValue" Name="idBarrioManzana" Type="Int32">
                                </asp:ControlParameter>
                            </SelectParameters>
                        </asp:SqlDataSource>
                        <asp:DropDownList ID="oddlBarrioManzanaLoteReubica" runat="server"
                            DataSourceID="odsbarrioManzanaLoteReubica" DataTextField="BARRIOLOTEDescripcion"
