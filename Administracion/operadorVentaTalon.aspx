<%@ Page Title="Entrega de cupones numerados asignados." MaintainScrollPositionOnPostback="true" Language="VB" MasterPageFile="~/master/p.master" AutoEventWireup="false" CodeFile="operadorVentaTalon.aspx.vb" Inherits="Administracion_operadorVentaTalon" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <asp:Panel ID="PanelTalonSeleccion" runat="server" Visible="true" CssClass="panel-talon-seleccion">
        <div>
        ...
        <div>
            <asp:TextBox ID="otxtCantidad" runat="server" Text="200" Enabled="false" Visible="false"></asp:TextBox>
        ...
        <div align="center">
            <asp:Button ID="obutCobrar" runat="server" Text="Cobrar" CssClass="btn-basic btn-success btn-margin" />
