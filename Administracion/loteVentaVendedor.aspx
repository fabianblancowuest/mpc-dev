<%@ Page Language="VB" MasterPageFile="~/master/p.master" MaintainScrollPositionOnPostback="true" AutoEventWireup="false" CodeFile="loteVentaVendedor.aspx.vb" Inherits="STRSYSTEM_Administracion_LOTEVENTAVENDEDOR" Title="Tratamiento de venta de lotes por vendedor" Culture="es-AR" %>
...
<asp:Calendar ID="Calendar2" runat="server"></asp:Calendar>
    ...
    <asp:Panel ID="PanelDocumentacion" runat="server" Visible ="false">
        <div>
            <asp:Button ID="obutVolver" runat="server" Text="Volver" Height ="80px" Width="200px" BackColor ="Green" ForeColor="White" Font-Bold="true" />
        </div>
          <div>
