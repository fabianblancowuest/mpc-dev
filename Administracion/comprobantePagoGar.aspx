<%@ Page Title="Comprobante de Pago" Language="VB" MasterPageFile="~/master/p.master" AutoEventWireup="false" CodeFile="comprobantePagoGar.aspx.vb" Inherits="Administracion_comprobantePagoGar" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
  ...
  --%>      <div>
      ...
      <br />   </div>
      <div align="center" >
      <asp:TextBox ID="olblAsientoCabeceraExplicacion" runat="server" Width ="95%" Height ="400px" TextMode ="MultiLine" enabled ="false" Font-Size="Medium" ></asp:TextBox>
     </div>=
        <div align="center" >
            <asp:SqlDataSource ID="odspagoComprobanteConcepto" runat="server" ConnectionString="<%$ ConnectionStrings:STRSYSTEM %>" SelectCommand="pagoComprobanteConceptoGAR" SelectCommandType="StoredProcedure">
                <SelectParameters>
   ...
   <%-- </asp:Panel>
    ...
    --%>    <div>
        ...
        <div align="center">
            <asp:SqlDataSource ID="odspagoComprobanteValor" runat="server" ConnectionString="<%$ ConnectionStrings:STRSYSTEM %>" SelectCommand="pagoComprobanteValorGAR" SelectCommandType="StoredProcedure">
                <SelectParameters>
                    <asp:ControlParameter ControlID="olblComprobanteNumero" Name="idAsientoCabecera" PropertyName="Text" Type="Int32" />
                </SelectParameters>
            </asp:SqlDataSource>
