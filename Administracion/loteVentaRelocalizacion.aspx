        ...
        <div class="lote-venta-liberacion-select">
            <asp:Panel ID="PanelUltimasRelocalizaciones" runat="server">
                <div class="text-center">
                    <asp:Label ID="Label11" runat="server" Text="Últimas relocalizaciones" Visible="true"
                        CssClass="subtitulo-rol"></asp:Label>
                    <asp:Button ID="obutNuevaRelocalizacion" runat="server" Text="Nueva Relocalización"
                    ...
                    <asp:GridView ID="ogvloteVentaUltimasRelocalizaciones" runat="server" AllowSorting="True"
                        ...
                        <Columns>
                            <asp:BoundField DataField="idLoteVentaRelocalizaOperador" HeaderText="id Relocaliza"
                                InsertVisible="False" SortExpression="idLoteVentaRelocalizaOperador">
                                <ItemStyle HorizontalAlign="Center" />
                            </asp:BoundField>
                            <asp:BoundField DataField="fechaOperacion" HeaderText="Fecha Operacion"
                                SortExpression="fechaOperacion" />
                            <asp:BoundField DataField="operador" HeaderText="operador" SortExpression="operador" />
                            <asp:BoundField DataField="descripcion" HeaderText="descripcion"
                                SortExpression="descripcion" />
                            <asp:BoundField DataField="idLoteVenta" HeaderText="idLoteVenta"
                                SortExpression="idLoteVenta" />
                            <asp:BoundField DataField="idBarrioLoteOrigen" HeaderText="idBarrioLoteOrigen"
                                SortExpression="idBarrioLoteOrigen" />
                            <asp:BoundField DataField="idBarrioLoteDestino" HeaderText="idBarrioLoteDestino"
                                SortExpression="idBarrioLoteDestino" />
                        </Columns>
                    </asp:GridView>
                </div>
            </asp:Panel>
