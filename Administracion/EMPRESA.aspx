<%@ Page Language="VB" MasterPageFile="~/master/p.master" AutoEventWireup="false" CodeFile="EMPRESA.aspx.vb" Inherits="STRSYSTEM_Administracion_EMPRESA" title="Tratamiento Tabla " Culture="es-AR"                  %> 
...
<asp:Label ID="olblEMPRESATitulo" runat="server" Text=""></asp:Label>   
      </h1>
    </div>
 </asp:Panel> 
        ...
        <asp:Panel ID="Panel1" runat="server">
         ...
         <div class="row contenedor-flexible my-2">
              ...
              <asp:SqlDataSource ID="odsEMPRESA" runat="server" 
                  ...
                  SelectCommand="EMPRESATRAERCADENA" SelectCommandType="StoredProcedure" ProviderName="System.Data.SqlClient">           
                  <SelectParameters>
                   <asp:ControlParameter ControlID="otxtCadena" Name="cadena" PropertyName="Text" Type="String" />
                  </SelectParameters>
              </asp:SqlDataSource>
<div class="table-responsive">
             <asp:GridView ID="ogvEMPRESA" runat="server" AutoGenerateColumns="False"  CssClass="table-cemmi" AlternatingRowStyle-CssClass="alt" AllowPaging="True" PageSize="15" PagerStyle-CssClass="pgr"         
               ...
               <asp:CommandField ShowSelectButton="True" SelectText="Seleccione"> 
                     ...
                     <asp:BoundField DataField="IDEMPRESA" HeaderText=""    
                        InsertVisible="False" ReadOnly="True" visible="False" 
                        SortExpression="IDEMPRESA"/>
                     <asp:BoundField DataField="EMPRESACODIGO" HeaderText=""    
                   ...
                   <asp:TemplateField HeaderText=""  SortExpression="EMPRESAESTADO" >  
                     <ItemTemplate>
                     <asp:CheckBox ID="EMPRESAESTADOBox"  runat="server" Checked='<% # Bind("EMPRESAESTADO") %>' Enabled="false"  />         
                   </ItemTemplate>
...
<asp:Label ID="olblEMPRESACODIGO" runat="server" Text=":" CssClass="control-label"></asp:Label>     
         <asp:TextBox ID="otxtEMPRESACODIGO" runat="server" CssClass="form-control" MaxLength="50"></asp:TextBox>       
</div>
<div class="form-group">
<asp:Label ID="olblEMPRESADESCRIPCION" runat="server" Text=":" CssClass="control-label"></asp:Label>       
         <asp:TextBox ID="otxtEMPRESADESCRIPCION" runat="server" CssClass="form-control" MaxLength="50"></asp:TextBox>        
</div>
<div class="form-group">
<asp:Label ID="olblEMPRESAEXPLICACION" runat="server" Text=":" CssClass="control-label"></asp:Label>      
         <asp:TextBox ID="otxtEMPRESAEXPLICACION" runat="server" CssClass="form-control" TextMode="MultiLine" height="500px" ></asp:TextBox>        
</div>
<div class="form-group">
