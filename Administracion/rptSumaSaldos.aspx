<%@ Page Title="Reporte de sumas y saldos" Language="VB" MasterPageFile="~/master/p.master" AutoEventWireup="false" CodeFile="rptSumaSaldos.aspx.vb" Inherits="Administracion_rptSumaSaldos" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">

    <asp:Panel ID="PanelSumaSaldos" runat="server">
        <div>
        ...
        <div>
            <asp:SqlDataSource ID="odsSumaSaldos" runat="server" ConnectionString="<%$ ConnectionStrings:STRSYSTEM %>" SelectCommand="rptSumaSaldosGlobalOptimo" SelectCommandType="StoredProcedure">
                <SelectParameters>
                    ...
                    <asp:ControlParameter ControlID="ochkImputaciones" Name="imputaciones" PropertyName="Checked" Type="Boolean" />
                </SelectParameters>
            </asp:SqlDataSource>
            <asp:GridView ID="ogvSumaSaldos" runat="server" AutoGenerateColumns="False" CssClass="table-cemmi" DataSourceID="odsSumaSaldos" DataKeyNames="idPlanCuenta,planCuentaCodigo,planCuentaImputable" Font-Size="X-Small" EmptyDataText="No existen imputaciones contables en el período seleccionado.">
                <Columns>
                    <asp:CommandField SelectText="Detalle" ShowSelectButton="True" />
                    <asp:BoundField DataField="idPlanCuenta" HeaderText="id" SortExpression="idPlanCuenta" InsertVisible="False" ReadOnly="True" />
                    <asp:BoundField DataField="planCuentaCodigo" HeaderText="Codigo" SortExpression="planCuentaCodigo" />
                    <asp:BoundField DataField="planCuentaDescripcion" HeaderText="Cuenta" SortExpression="planCuentaDescripcion">
                    </asp:BoundField>
                    <asp:CheckBoxField DataField="planCuentaImputable" HeaderText="Imputable" SortExpression="planCuentaImputable" >
                    <ItemStyle HorizontalAlign="Center" />
                    </asp:CheckBoxField>
                    <asp:BoundField DataField="Imputaciones" HeaderText="Cantidad imputaciones" ReadOnly="True" SortExpression="Imputaciones" >
                    <ItemStyle HorizontalAlign="Center" />
                    </asp:BoundField>
                    <asp:BoundField DataField="Debe" HeaderText="Debe" ReadOnly="True" SortExpression="Debe" DataFormatString="{0:c}" >
                    <ItemStyle HorizontalAlign="Right" />
                    </asp:BoundField>
                    <asp:BoundField DataField="Haber" HeaderText="Haber" ReadOnly="True" SortExpression="Haber" DataFormatString="{0:c}" >
                    <ItemStyle HorizontalAlign="Right" />
                    </asp:BoundField>
                    <asp:BoundField DataField="Saldo" HeaderText="Saldo" ReadOnly="True" SortExpression="Saldo" DataFormatString="{0:c}" >
                    <ItemStyle HorizontalAlign="Right" />
                    </asp:BoundField>
                </Columns>
            </asp:GridView>
