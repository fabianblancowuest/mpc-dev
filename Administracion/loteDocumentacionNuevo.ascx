<%@ Control Language="VB"  AutoEventWireup="false" CodeFile="loteDocumentacionNuevo.ascx.vb" Inherits="Administracion_loteDocumentacionNuevo" %>
...
<asp:Label ID="olblAdministracionControl" runat="server" Text="N"  Visible ="false"></asp:Label>
...
<div>
<asp:Label ID="olblImagenTipoDescripcion" runat="server" Text="" Font-Bold="true" Font-Size="Larger" ></asp:Label>
</div>
<div>
<asp:Label ID="olblImagenTipoExplicacion" runat="server" Text="" Font-Italic="true" Visible="false"></asp:Label>
</div>
    <table>
        <tr>
           <td>
               
<asp:Image ID="oimgImagen" runat="server" Height ="80%" Width ="80%" ImageUrl="~/miPrimerCasa.png" BorderWidth ="1" BorderStyle ="Double" />


           </td>
            <td>
                <asp:Panel ID="PanelAdministracionControl" runat="server" Visible="false">              
