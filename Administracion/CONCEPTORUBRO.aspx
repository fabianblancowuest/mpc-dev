<%@ Page Language="VB" MasterPageFile="~/master/p.master" AutoEventWireup="false" CodeFile="CONCEPTORUBRO.aspx.vb"
   Inherits="STRSYSTEM_Administracion_CONCEPTORUBRO" title="Tratamiento Tabla RUBRO DE CONCEPTOS" Culture="es-AR" %>
      ...
      <asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
         ...
         <asp:Panel ID="Panel1" runat="server" CssClass="rubro-de-conceptos">
            ...
            <div>
               ...
               <asp:SqlDataSource ID="odsCONCEPTORUBRO" runat="server"
                  ConnectionString="<%$ ConnectionStrings:STRSYSTEM %>" SelectCommand="CONCEPTORUBROTRAERCADENA"
               ...
               <div class="table-responsive">
                  <asp:GridView ID="ogvCONCEPTORUBRO" runat="server" AutoGenerateColumns="False" CssClass="table-cemmi"
                     ...
                     <Columns>
                        ...
                        <asp:BoundField DataField="IDCONCEPTORUBRO" HeaderText="ID" InsertVisible="False"
                        ...
                        <asp:TemplateField HeaderText="DEBITA CUENTA (ACTIVE=VERDADERO , INACTIVO=FALSO)"
                           SortExpression="CONCEPTORUBROCUENTADEBITA">
                           <ItemTemplate>
                              <asp:CheckBox ID="CONCEPTORUBROCUENTADEBITABox" runat="server"
                                 Checked='<% # Bind("CONCEPTORUBROCUENTADEBITA") %>' Enabled="false" />
                           </ItemTemplate>
                           <ItemStyle HorizontalAlign="Center" />
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="ESTADO RUBRO (ACTIVO=TRUE,BAJA =FALSE)"
                           SortExpression="CONCEPTORUBROESTADO">
                           <ItemTemplate>
                              <asp:CheckBox ID="CONCEPTORUBROESTADOBox" runat="server"
                                 Checked='<% # Bind("CONCEPTORUBROESTADO") %>' Enabled="false" />
                           </ItemTemplate>
                           <ItemStyle HorizontalAlign="Center" />
                        </asp:TemplateField>
                     </Columns>
         ...
         <asp:Panel ID="PanelAlta" runat="server" Visible="false">
            <form class="form" role="form">
               ...
               <div class="form-group">
                  <asp:Label ID="olblCONCEPTORUBROCODIGO" runat="server" Text="CODIGO RUBRO:" CssClass="control-label">
                  </asp:Label>
                  <asp:TextBox ID="otxtCONCEPTORUBROCODIGO" runat="server" CssClass="form-control" MaxLength="50">
                  </asp:TextBox>
               </div>
               <div class="form-group">
                  <asp:Label ID="olblCONCEPTORUBRODESCRIPCION" runat="server" Text="DESCRIPCION RUBRO:"
                     CssClass="control-label"></asp:Label>
                  <asp:TextBox ID="otxtCONCEPTORUBRODESCRIPCION" runat="server" CssClass="form-control" MaxLength="50">
                  </asp:TextBox>
               </div>
               <div class="form-group">
                  <asp:Label ID="olblCONCEPTORUBROEXPLICACION" runat="server" Text="EXPLICACION RUBRO:"
                     CssClass="control-label"></asp:Label>
                  <asp:TextBox ID="otxtCONCEPTORUBROEXPLICACION" runat="server" CssClass="form-control"
                     TextMode="MultiLine" height="500px"></asp:TextBox>
               </div>
               <div class="form-group">
                  <asp:Label ID="olblCONCEPTORUBROCUENTADEBITA" runat="server"
                     Text="DEBITA CUENTA (ACTIVE=VERDADERO , INACTIVO=FALSO):" CssClass="control-label"></asp:Label>
                  <asp:CheckBox ID="otxtCONCEPTORUBROCUENTADEBITA" runat="server" />
               </div>
               <div class="form-group">
                  <asp:Label ID="olblCONCEPTORUBROESTADO" runat="server" Text="ESTADO RUBRO (ACTIVO=TRUE,BAJA =FALSE):"
                     CssClass="control-label"></asp:Label>
