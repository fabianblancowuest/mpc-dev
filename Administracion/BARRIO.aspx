<%@ Page Language="VB" MasterPageFile="~/master/p.master" AutoEventWireup="false" CodeFile="BARRIO.aspx.vb"
    ...
    <%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="asp" %>
        ...
        <asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
            ...
            <asp:Panel ID="Panel1" runat="server" CssClass="barrios">
                ...
                <div>
                    ...
                    <asp:SqlDataSource ID="odsBARRIO" runat="server"
                        ConnectionString="<%$ ConnectionStrings:STRSYSTEM %>" SelectCommand="BARRIOTRAERCADENA"
                    ...
                    <div class="table-responsive">
                        <asp:GridView ID="ogvBARRIO" runat="server" AutoGenerateColumns="False"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="BARRIOPLANO" HeaderText="IMAGEN DEL PLANO GENERAL DEL BARRIO"
                                    SortExpression="BARRIOPLANO" Visible="False" />
                                ...
                                <asp:BoundField DataField="IDACTUALIZACIONMODO" HeaderText="MODO DE ACTUALIZACION"
                                    ...
                                    visible="False" />
                                <asp:BoundField DataField="Contenedor" HeaderText="BARRIO CONTENEDOR"
                                    SortExpression="Contenedor" />
                                <asp:BoundField DataField="periodoActualizacionCuota"
                                    HeaderText="PERIODO ACTUALIZACION CUOTA "
                                    SortExpression="periodoActualizacionCuota" />
                            </Columns>
