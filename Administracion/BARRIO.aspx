        ...
        <asp:Panel ID="Panel1" runat="server">
         ...
         <div class="row">
              ...
              <asp:SqlDataSource ID="odsBARRIO" runat="server" 
                  ...
                  SelectCommand="BARRIOTRAERCADENAVISTA" SelectCommandType="StoredProcedure">         
                  <SelectParameters>
                   <asp:ControlParameter ControlID="otxtCadena" Name="cadena" PropertyName="Text" Type="String" />
                  </SelectParameters>
              </asp:SqlDataSource>
<div class="table-responsive">
             <asp:GridView ID="ogvBARRIO" runat="server" AutoGenerateColumns="False"  CssClass="table-cemmi" AlternatingRowStyle-CssClass="alt" AllowPaging="True" PageSize="200" PagerStyle-CssClass="pgr"       
               ...
               AllowSorting="True" Font-Size="Smaller" >
                 ...
                 <Columns>
                     ...
                     <asp:BoundField DataField="BARRIOPLANO" HeaderText="IMAGEN DEL PLANO GENERAL DEL BARRIO" SortExpression="BARRIOPLANO" />
                     ...
                     <asp:TemplateField HeaderText="HABILITADO PARA LA VENTA" SortExpression="BARRIOVENDEDORHABILITADO">
                         <ItemTemplate>
                             <asp:CheckBox ID="BARRIOVENDEDORHABILITADOBox" runat="server" Checked='<% # Bind("BARRIOVENDEDORHABILITADO") %>' Enabled="false" />
                         </ItemTemplate>
                         <ItemStyle HorizontalAlign="Center" />
                     </asp:TemplateField>
                     <asp:BoundField DataField="IDCENTROCOSTO" HeaderText="CENTRO COSTO ASIGNADO" InsertVisible="False" ReadOnly="True" SortExpression="IDCENTROCOSTO" visible="False" />
                     <asp:BoundField DataField="BARRIOPORCENTAJECOMISIONADHESION" HeaderText="COMISION POR ADHESION" SortExpression="BARRIOPORCENTAJECOMISIONADHESION">
                     <ItemStyle HorizontalAlign="Right" />
                     </asp:BoundField>
                     <asp:BoundField DataField="BARRIOPORCENTAJECOMISIONCUOTA" HeaderText="COMISION POR COBRANZA DE CUOTA" SortExpression="BARRIOPORCENTAJECOMISIONCUOTA">
                     <ItemStyle HorizontalAlign="Right" />
                     </asp:BoundField>
                     <asp:BoundField DataField="centroCostoDescripcion" HeaderText="Centro Costo" SortExpression="centroCostoDescripcion" />
                 </Columns>
...
<div class="form-group">
<asp:Label ID="olblBARRIOVENDEDORHABILITADO" runat="server" Text="HABILITADO PARA LA VENTA:" CssClass="control-label"></asp:Label>              
      <asp:CheckBox ID="otxtBARRIOVENDEDORHABILITADO" runat="server"  />       
</div>
<div class="form-group">
<asp:Label ID="olblIDCENTROCOSTO" runat="server" Text="CENTRO COSTO ASIGNADO:" CssClass="control-label"></asp:Label>            
                         <asp:SqlDataSource ID="odsCENTROCOSTO" runat="server"       
                ConnectionString="<%$ ConnectionStrings:STRSYSTEM %>"   
                SelectCommand="CENTROCOSTOTraerOddl" SelectCommandType="StoredProcedure"></asp:SqlDataSource>          
                        <asp:DropDownList ID="oddlCENTROCOSTO" runat="server" DataSourceID="odsCENTROCOSTO"      
                DataTextField="CENTROCOSTODescripcion" DataValueField="IDCENTROCOSTO" CssClass="form-control">       
            </asp:DropDownList> 
</div>
<div class="form-group">
<asp:Label ID="olblBARRIOPORCENTAJECOMISIONADHESION" runat="server" Text="COMISION POR ADHESION:" CssClass="control-label"></asp:Label>                  
         <asp:TextBox ID="otxtBARRIOPORCENTAJECOMISIONADHESION" runat="server" CssClass="form-control" MaxLength="12"></asp:TextBox>             
</div>
<div class="form-group">
<asp:Label ID="olblBARRIOPORCENTAJECOMISIONCUOTA" runat="server" Text="COMISION POR COBRANZA DE CUOTA:" CssClass="control-label"></asp:Label>                     
         <asp:TextBox ID="otxtBARRIOPORCENTAJECOMISIONCUOTA" runat="server" CssClass="form-control" MaxLength="12"></asp:TextBox>            
</div>
