<%@ Page Language="VB" MasterPageFile="~/master/p.master" AutoEventWireup="false" CodeFile="EMPRESASUCURSAL.aspx.vb" Inherits="STRSYSTEM_Administracion_EMPRESASUCURSAL" title="Tratamiento Tabla " Culture="es-AR"                          %> 
...
<asp:Label ID="olblEMPRESASUCURSALTitulo" runat="server" Text=""></asp:Label>       
      </h1>
    </div>
 </asp:Panel> 
        ...
        <asp:Panel ID="Panel1" runat="server">
         ...
         <div class="row">
             ...
             SelectCommand="EMPRESAOPERADORSELECCIONA" SelectCommandType="StoredProcedure">                
              <SelectParameters>
...
<div>
              ...
              <asp:SqlDataSource ID="odsEMPRESASUCURSAL" runat="server"     
                ...
                <SelectParameters>
               <asp:ControlParameter ControlID="oddlEMPRESAOperador" Name="idEMPRESA" PropertyName="SelectedValue" Type="Int16"  />       
               </SelectParameters>
              </asp:SqlDataSource>
<div class="table-responsive">
             <asp:GridView ID="ogvEMPRESASUCURSAL" runat="server" AutoGenerateColumns="False"  CssClass="table-cemmi" AlternatingRowStyle-CssClass="alt" AllowPaging="True" PageSize="15" PagerStyle-CssClass="pgr"            
               ...
               <asp:CommandField ShowSelectButton="True" SelectText="Seleccione"> 
                     ...
                     <asp:BoundField DataField="IDEMPRESASUCURSAL" HeaderText="id"     
                        InsertVisible="False" ReadOnly="True" visible="False" 
                        SortExpression="IDEMPRESASUCURSAL"/>
                   ...
                   <asp:TemplateField HeaderText="Estado (habilitado / inhabilitado)"  SortExpression="EMPRESASUCURSALESTADO" >   
                     <ItemTemplate>
                     <asp:CheckBox ID="EMPRESASUCURSALESTADOBox"  runat="server" Checked='<% # Bind("EMPRESASUCURSALESTADO") %>' Enabled="false"  />                
                   </ItemTemplate>
...
<div class="form-group">
<asp:Label ID="olblEMPRESASUCURSALCODIGO" runat="server" Text="Codigo Sucursal:" CssClass="control-label"></asp:Label>          
         <asp:TextBox ID="otxtEMPRESASUCURSALCODIGO" runat="server" CssClass="form-control" MaxLength="50"></asp:TextBox>           
</div>
<div class="form-group">
<asp:Label ID="olblEMPRESASUCURSALDESCRIPCION" runat="server" Text="Descripción Sucursal:" CssClass="control-label"></asp:Label>           
         <asp:TextBox ID="otxtEMPRESASUCURSALDESCRIPCION" runat="server" CssClass="form-control" MaxLength="50"></asp:TextBox>            
</div>
<div class="form-group">
<asp:Label ID="olblEMPRESASUCURSALEXPLICACION" runat="server" Text="Descripción Adicional:" CssClass="control-label"></asp:Label>         
         <asp:TextBox ID="otxtEMPRESASUCURSALEXPLICACION" runat="server" CssClass="form-control" TextMode="MultiLine" height="500px" ></asp:TextBox>           
</div>
<div class="form-group">
<asp:Label ID="olblEMPRESASUCURSALESTADO" runat="server" Text="Estado (habilitado / inhabilitado):" CssClass="control-label"></asp:Label>      
