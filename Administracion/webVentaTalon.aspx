<%@ Page Title="Entrega de cupones numerados asignados." MaintainScrollPositionOnPostback="true" Language="VB" MasterPageFile="~/master/p.master" AutoEventWireup="false" CodeFile="webVentaTalon.aspx.vb" Inherits="Administracion_webVentaTalon" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <asp:Panel ID="PanelTalonSeleccion" runat="server" Visible="true">
        ...
        <div>
            <asp:TextBox ID="otxtCantidad" runat="server" Text="100" Enabled="false" Visible="false"></asp:TextBox>
    ...
    <asp:Panel ID="PanelCobranza" runat="server" Visible="false">
        ...
        <div>
            <asp:SqlDataSource ID="odsSorteoPremio" runat="server" ConnectionString="<%$ ConnectionStrings:STRSYSTEM %>" SelectCommand="SORTEOPREMIOTraeroddl" SelectCommandType="StoredProcedure"></asp:SqlDataSource>

            <asp:SqlDataSource ID="odsSorteoVendedorTalonSeleccionado" runat="server" ConnectionString="<%$ ConnectionStrings:STRSYSTEM %>" SelectCommand="SorteoVendedorTalonSeleccionado" SelectCommandType="StoredProcedure">
                <SelectParameters>
                    <asp:SessionParameter Name="idOperador" SessionField="idOperador" Type="Int32" />
                </SelectParameters>
            </asp:SqlDataSource>
        ...
        <div align="center">
            <asp:Label ID="Label5" runat="server" Text="Cantidad de talones seleccionados : " Font-Bold="true"></asp:Label>
    ...
    <asp:Panel ID="PanelValores" runat="server" Visible="false">
        ...
        <asp:Panel ID="PanelTransferencia" runat="server" Visible="true">
            <div>
                <div align="center">
                    <asp:TextBox ID="otxtDatosBancoParaTransferencia01" runat="server" BackColor="LightGray" Width="90%" Text="Datos cuenta corriente en Banco de Formosa" Font-Bold="true"></asp:TextBox>
                </div>
                <div align="center">
                    <asp:TextBox ID="otxtDatosBancoParaTransferencia02" runat="server" BackColor="LightGray" Width="90%" Text="CBU : 3150100612004333360010" Font-Bold="true"></asp:TextBox>
                </div>
                <div align="center">
                    <asp:TextBox ID="otxtDatosBancoParaTransferencia03" runat="server" BackColor="LightGray" Width="90%" Text="ALIAS : " Font-Bold="true"></asp:TextBox>
                </div>
