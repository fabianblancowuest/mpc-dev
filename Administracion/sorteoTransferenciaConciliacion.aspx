<%@ Page Title="Conciliacion de transferencias a entidades de recaudacion electronica"
    ...
    <asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
        ...
        <div>
            ...
            <h2 class="subtitulo-rol">Comprobantes pendientes de conciliacion</h2>
        </div>
        <div>
            ...
            <div>
                ...
                <div class="contenedor-responsive">
                    <asp:GridView ID="ogvsorteoTransferenciaNoConciliados" runat="server" AutoGenerateColumns="False"
                        CssClass="table-cemmi fuente-mas-chica"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="idSorteoTalonCobranza" HeaderText="Cobranza"
                                InsertVisible="False" ReadOnly="True" SortExpression="idSorteoTalonCobranza">
