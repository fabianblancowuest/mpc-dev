<%@ Page Language="VB" MaintainScrollPositionOnPostback="true"  MasterPageFile="~/master/p.master" AutoEventWireup="false" CodeFile="loteVentaNovedad.aspx.vb" Inherits="STRSYSTEM_Administracion_loteVentaNovedad" Title="Tratamiento de Novedades de LOTES EN BARRIOS" Culture="es-AR" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <asp:Panel ID="PanelTitulo" runat="server">
        <div class="row">
            <h1>
                ...
                <asp:Label ID="olblBARRIOLOTETitulo" runat="server" Text="NOVEDADES DE LOTES EN BARRIOS"></asp:Label>
            </h1>
        </div>
    </asp:Panel>
    ...
    <asp:Panel ID="Panel1" runat="server">
        ...
        <div class="row">
            ...
            <div class="form-group">
                <asp:Label ID="Label3" runat="server" Text="SELECCIONE MANZANA:" CssClass="control-label"></asp:Label>
                ...
                <asp:DropDownList ID="oddlBarrioManzanaOperador" runat="server" DataSourceID="odsBARRIOMANZANAOPERADOR"
                    DataTextField="barrioManzanaCodigo" DataValueField="idBarrioManzana" CssClass="form-control" AutoPostBack="True">
                </asp:DropDownList>
            </div>
        </div>
        <div>
            ...
            <div class="table-responsive">
                <asp:GridView ID="ogvBARRIOLOTE" runat="server" AutoGenerateColumns="False" CssClass="table-cemmi" AlternatingRowStyle-CssClass="alt" AllowPaging="True" PageSize="45" PagerStyle-CssClass="pgr"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="IDBARRIOLOTE" HeaderText="id Lote" InsertVisible="False" ReadOnly="True" SortExpression="IDBARRIOLOTE" />
                        ...
                        <asp:BoundField DataField="IDBARRIOMANZANA" HeaderText="MANZANA" InsertVisible="False" ReadOnly="True" SortExpression="IDBARRIOMANZANA" Visible="False" />
                        <asp:BoundField DataField="BARRIOLOTEPARCELA" HeaderText="PARCELA" SortExpression="BARRIOLOTEPARCELA" >
                        <ItemStyle Font-Bold="True" HorizontalAlign="Center" />
                        </asp:BoundField>
                        <asp:BoundField DataField="MOVIMIENTOS" HeaderText="MOVIMIENTOS" SortExpression="MOVIMIENTOS" >
                        <ItemStyle HorizontalAlign="Center" />
                        </asp:BoundField>
                        <asp:BoundField DataField="BARRIOLOTEFRENTEMETROS" HeaderText="FTE (M)" SortExpression="BARRIOLOTEFRENTEMETROS" Visible="False" >
                        </asp:BoundField>
                        <asp:BoundField DataField="BARRIOLOTELADOIZQUIERDOMETROS" HeaderText="LIZQ (M)" SortExpression="BARRIOLOTELADOIZQUIERDOMETROS" Visible="False" >
                        <ItemStyle HorizontalAlign="Center" />
                        </asp:BoundField>
                        <asp:BoundField DataField="BARRIOLOTEFONDOMETROS" HeaderText="FDO (M)" SortExpression="BARRIOLOTEFONDOMETROS" Visible="False" >
                        <ItemStyle HorizontalAlign="Center" />
                        </asp:BoundField>
                        <asp:BoundField DataField="BARRIOLOTELADODERECHOMETROS" HeaderText="LDER (M)" SortExpression="BARRIOLOTELADODERECHOMETROS" Visible="False">
                        <ItemStyle HorizontalAlign="Center" />
                        <ItemStyle HorizontalAlign="Center" />
                        </asp:BoundField>
                        <asp:BoundField DataField="BARRIOLOTESUPERFICIE" HeaderText="SUP (M2)" SortExpression="BARRIOLOTESUPERFICIE" >
                        <ItemStyle HorizontalAlign="Center" Wrap="True" />
                        </asp:BoundField>
                        <asp:BoundField DataField="loteTipoDescripcion" HeaderText="Tipo de Lote" SortExpression="loteTipoDescripcion" />
                        <asp:TemplateField HeaderText="ORIENTACION" InsertVisible="False" SortExpression="IDORIENTACION" Visible="False">
                            <EditItemTemplate>
                                <asp:Label ID="Label1" runat="server" Text='<%# Eval("IDORIENTACION") %>'></asp:Label>
                            </EditItemTemplate>
                            <ItemTemplate>
                                <%--<asp:Label ID="Label1" runat="server" Text='<%# Bind("IDORIENTACION") %>'></asp:Label>--%>
                                <asp:DropDownList ID="oddlOrientacionLote" runat="server" DataSourceID="odsORIENTACION" DataTextField="orientacionDescripcion" DataValueField="idOrientacion" SelectedValue='<%# Bind("IDORIENTACION") %>' Enabled="false">
                                </asp:DropDownList>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:BoundField DataField="SECUENCIA" HeaderText="SECUENCIA (En sentido horario)" SortExpression="SECUENCIA" Visible="False">
                            <ItemStyle HorizontalAlign="Right" />
                        </asp:BoundField>
                        <asp:TemplateField HeaderText="TIPO DE LOTE" InsertVisible="False" SortExpression="IDLOTETIPO" Visible="False">
                            <ItemTemplate>
                               <%-- <asp:Label ID="Label2" runat="server" Text='<%# Eval("IDLOTETIPO") %>'></asp:Label>--%>
                                 <asp:DropDownList ID="oddlLoteTipo" runat="server" DataSourceID="odsLoteTipo" DataTextField="loteTipoDescripcion" DataValueField="idLoteTipo" SelectedValue='<%# Bind("IDLOTETIPO") %>' Enabled ="false" >
                                </asp:DropDownList>
                            </ItemTemplate>
                        ...
                        <asp:BoundField DataField="BARRIOLOTEPRECIOREFERENCIABC" HeaderText="PRECIO TOTAL EN BC" SortExpression="BARRIOLOTEPRECIOREFERENCIABC">
                            <ItemStyle HorizontalAlign="Center" />
                        </asp:BoundField>
                        <asp:BoundField DataField="BARRIOLOTEADHESIONREFERENCIA" HeaderText="MONTO ADHESION EN PESOS" SortExpression="BARRIOLOTEADHESIONREFERENCIA" DataFormatString="{0:c}">
                            <ItemStyle HorizontalAlign="Center" />
                        </asp:BoundField>
                        <asp:TemplateField HeaderText="ESTADO DEL LOTE" SortExpression="BARRIOLOTEESTADO" Visible="False">
                            <ItemTemplate>
                                <asp:CheckBox ID="BARRIOLOTEESTADOBox" runat="server" Checked='<% # Bind("BARRIOLOTEESTADO")%>' Enabled="false" />
                            </ItemTemplate>
                            <ItemStyle HorizontalAlign="Center" />
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="LOTE VENDIDO ?" SortExpression="BARRIOLOTEENVENTA" Visible="False">
                            <ItemTemplate>
                                <asp:CheckBox ID="BARRIOLOTEENVENTABox" runat="server" Checked='<% # Bind("BARRIOLOTEENVENTA")%>' Enabled="false" />
                            </ItemTemplate>
                            <ItemStyle HorizontalAlign="Center" />
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="LOTE BONIFICADO ?" SortExpression="BARRIOLOTEBONIFICADO" Visible="False">
                            <ItemTemplate>
                                <asp:CheckBox ID="BARRIOLOTEBONIFICADOBox" runat="server" Checked='<% # Bind("BARRIOLOTEBONIFICADO")%>' Enabled="false" />
                            </ItemTemplate>
                            <ItemStyle HorizontalAlign="Center" />
                        </asp:TemplateField>
                        <asp:BoundField DataField="PARCELACATASTRAL" HeaderText="NOMENCLATURA CATASTRAL" SortExpression="PARCELACATASTRAL" Visible="False" />
                        <asp:BoundField DataField="idLoteVenta" HeaderText="id Venta" InsertVisible="False" SortExpression="idLoteVenta" />
                        ...
                        <asp:BoundField DataField="loteVentafechaCancelacion" DataFormatString="{0:d}" HeaderText="Fecha Cancelacion" SortExpression="loteVentafechaCancelacion" >
                        <ItemStyle HorizontalAlign="Center" />
                        </asp:BoundField>
                    </Columns>
                    <PagerStyle CssClass="pgr" />
                </asp:GridView>
                <asp:SqlDataSource ID="odsBarrioManzanaResumen" runat="server" ConnectionString="<%$ ConnectionStrings:STRSYSTEM %>" SelectCommand="BARRIOLOTEMANZANAESTADOADHESION" SelectCommandType="StoredProcedure">
                    <SelectParameters>
                        <asp:ControlParameter ControlID="oddlBarrioManzanaOperador" Name="idBarrioManzana" PropertyName="SelectedValue" Type="Int32" />
                    </SelectParameters>
                </asp:SqlDataSource>
                <asp:GridView ID="ogvBarrioManzanaResumen" runat="server" AutoGenerateColumns="False" CssClass="table-cemmi" DataSourceID="odsBarrioManzanaResumen" Width="50%">
                    <Columns>
                        <asp:BoundField DataField="TotalLotes" HeaderText="Total Lotes" ReadOnly="True" SortExpression="TotalLotes">
                        <ItemStyle HorizontalAlign="Center" />
                        </asp:BoundField>
                        <asp:BoundField DataField="TotalAdhesiones" HeaderText="Total Adhesiones" ReadOnly="True" SortExpression="TotalAdhesiones">
                        <ItemStyle HorizontalAlign="Center" />
                        </asp:BoundField>
                        <asp:BoundField DataField="TotalLibres" HeaderText="Total Libres" ReadOnly="True" SortExpression="TotalLibres">
                        <ItemStyle HorizontalAlign="Center" />
                        </asp:BoundField>
                    </Columns>
                </asp:GridView>
    ...
    <asp:Panel ID="PanelAlta" runat="server" Visible="false">
        <form class="form" role="form">
            ...
            <div class="form-group">
                ...
                <asp:SqlDataSource ID="odsBARRIOMANZANA" runat="server" ConnectionString="<%$ ConnectionStrings:STRSYSTEM %>" SelectCommand="BARRIOMANZANAOPERADORSELECCIONA" SelectCommandType="StoredProcedure">
                   
                    <SelectParameters>
                        <asp:SessionParameter Name="idOperador" SessionField="idOperador" Type="Int32" />
                        <asp:ControlParameter ControlID="oddlBARRIO" Name="idBarrio" PropertyName="SelectedValue" Type="Int32" />
                    </SelectParameters>
                   
                </asp:SqlDataSource>
                <asp:DropDownList ID="oddlBARRIOMANZANA" runat="server" DataSourceID="odsBARRIOMANZANA"
                    DataTextField="BARRIOMANZANADescripcion" DataValueField="IDBARRIOMANZANA" CssClass="form-control" AutoPostBack ="true">
                </asp:DropDownList>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
             ...
             <div class="form-group">
                <asp:Label ID="olblBARRIOLOTESUPERFICIE" runat="server" Text="SUPERFICIE EN METROS CUADRADOS:" CssClass="control-label"></asp:Label>
                <asp:TextBox ID="otxtBARRIOLOTESUPERFICIE" runat="server" CssClass="form-control" MaxLength="50"></asp:TextBox>
            </div>
            <div class="form-group">
                <asp:Label ID="olblIDORIENTACION" runat="server" Text="ORIENTACION EN CAR�TULA:" CssClass="control-label"></asp:Label>
            ...
            <div class="form-group">
                <asp:Label ID="olblSECUENCIA" runat="server" Text="SECUENCIA EN CAR�TULA (En sentido horario):" CssClass="control-label"></asp:Label>
         ...
         <asp:Panel ID="PanelGrlla" runat="server" Visible="false">
            ...
            <div>
             ...
             <div>
 <asp:Button ID="obutActualizaYVuelve" runat="server" Text="Actualizar y volver" BackColor="LightGreen"   />
             </div>
            <div>
