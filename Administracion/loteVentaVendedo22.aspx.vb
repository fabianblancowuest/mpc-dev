...
Partial Class STRSYSTEM_Administracion_LOTEVENTAVENDEDOR22
    ...
    Protected Sub obutCargarImagenes_Click(sender As Object, e As EventArgs) Handles obutCargarImagenes.Click
        PanelAlta.Visible = False
        PanelDocumentacion.Visible = True
        olblCLIENTE01NOMBRE.Text = "Cliente:" + ogvLOTEVENTA.SelectedDataKey.Item("CLIENTE01NOMBRE") + " , " + olblBarrioManzanaParcelaSeleccionado.Text
