<%@ Page Language="VB" MasterPageFile="~/master/p.master" AutoEventWireup="false" CodeFile="BARRIOESTADISTICA.aspx.vb"
    Inherits="STRSYSTEM_Administracion_BARRIOESTADISTICA" Title="ESTADISTICA DE AVANCE POR BARRIO" Culture="es-AR" %>
            ...
            <asp:Panel ID="Panel1" runat="server">
                ...
                <div>
                       ...
                       <asp:SqlDataSource ID="odsBarrioEstadisticaPorcentaje" runat="server"
                        ConnectionString="<%$ ConnectionStrings:STRSYSTEM %>" SelectCommand="barrioEstadisticasPorcentaje"
                        SelectCommandType="StoredProcedure">
                        <SelectParameters>
                            <asp:ControlParameter ControlID="oddlBARRIOOperador" Name="idBarrio"
                                PropertyName="SelectedValue" Type="Int32" />
                    ...
                    <br />
                        ...
                        <asp:GridView ID="ogvBarrioEstadisticaPorcentaje" runat="server" AutoGenerateColumns="False"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="Manzana" HeaderText="Manzana" SortExpression="Manzana" Visible="False" />
                                <asp:BoundField DataField="Lotes adheridos" HeaderText="Lotes adheridos" SortExpression="Lotes adheridos" />
                                <asp:BoundField DataField="Lotes libres" HeaderText="Lotes libres" SortExpression="Lotes libres" />
                                <asp:BoundField DataField="Avance Ventas" HeaderText="Avance Ventas" SortExpression="Avance Ventas" />
                                <asp:BoundField DataField="Superficie adherida" HeaderText="Superficie adherida" SortExpression="Superficie adherida">
                                </asp:BoundField>
                                <asp:BoundField DataField="BC adheridas" HeaderText="BC adheridas" SortExpression="BC adheridas" />
                                <asp:BoundField DataField="Adhesiones adheridas" HeaderText="Adhesiones adheridas" SortExpression="Adhesiones adheridas" />
                            </Columns>
                            <PagerStyle CssClass="pgr" />
                        </asp:GridView>
