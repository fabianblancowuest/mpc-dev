...
imports STRSYSTEM    
Partial Class STRSYSTEM_Administracion_BARRIOLOTECOMISIONEXTRAGESTION
    ...
    Protected Sub obutAlta_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles obutAlta.Click
        ...
        otxtBARRIOLOTECOMISIONEXTRACODIGO.text = ""
        otxtBARRIOLOTECOMISIONEXTRADESCRIPCION.text = ""
    ...
    Protected Sub ogvBARRIOLOTECOMISIONEXTRA_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles ogvBARRIOLOTECOMISIONEXTRA.SelectedIndexChanged
        ...
        otxtBARRIOLOTECOMISIONEXTRACODIGO.text = ogvBARRIOLOTECOMISIONEXTRA.SelectedDataKey.Item("BARRIOLOTECOMISIONEXTRACODIGO")
        otxtBARRIOLOTECOMISIONEXTRADESCRIPCION.text = ogvBARRIOLOTECOMISIONEXTRA.SelectedDataKey.Item("BARRIOLOTECOMISIONEXTRADESCRIPCION")
    ...
    Private Sub nombreTablaAM()
        ...
        Using connection As New System.Data.SqlClient.SqlConnection(connectionString)
            ...
            Try
                ...
                cmd.Parameters.Add("@BARRIOLOTECOMISIONEXTRACODIGO", Data.SqlDbType.Char).SqlValue = otxtBARRIOLOTECOMISIONEXTRACODIGO.text
                cmd.Parameters.Add("@BARRIOLOTECOMISIONEXTRADESCRIPCION", Data.SqlDbType.Char).SqlValue = otxtBARRIOLOTECOMISIONEXTRADESCRIPCION.text
