...
Partial Class Administracion_loteVentaRecuperacionBaja
    ...
    Protected Sub ogvloteVentaUltimasRelocalizaciones_SelectedIndexChanged(sender As Object, e As EventArgs) Handles ogvloteVentaUltimasRelocalizaciones.SelectedIndexChanged

        oddlBarrioHabilitadoSelecciona.SelectedIndex = ogvloteVentaUltimasRelocalizaciones.SelectedDataKey.Item("idBarrio")
        oddlBarrioHabilitadoSelecciona.Enabled = False
        olblIDLoteVenta.Text = ogvloteVentaUltimasRelocalizaciones.SelectedDataKey.Item("idLoteVenta")
