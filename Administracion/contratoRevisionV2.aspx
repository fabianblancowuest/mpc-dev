<%@ Page Title="Revision de contratos" MaintainScrollPositionOnPostback ="true" Language="VB" MasterPageFile="~/master/p.master" AutoEventWireup="false" CodeFile="contratoRevision - Copy.aspx.vb" Inherits="Administracion_contratoRevision" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <asp:Panel ID="PanelSeleccion" runat="server">
        <div>
            <asp:Label ID="Label1" runat="server" Text="Revision de contratos"></asp:Label>
        </div>
        <div>
            <asp:Label ID="Label2" runat="server" Text="Gestión de revisión de contratos de adhesión celebrados con clientes"></asp:Label>
        </div>
        ...
        <div>
            ...
            <div class="table-responsive">
                <asp:Button ID="obutAlta" runat="server" Text="Alta Nueva adhesion en lote " BackColor="Green" ForeColor="White" />
                <asp:GridView ID="ogvLOTEVENTA" runat="server" AutoGenerateColumns="False" CssClass="table-cemmi" AlternatingRowStyle-CssClass="alt" AllowPaging="True" PageSize="15" PagerStyle-CssClass="pgr"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="LOTEPRECIOBC" HeaderText="PRECIO TOTAL BC" SortExpression="LOTEPRECIOBC" />
                        <asp:BoundField DataField="CUOTABC" HeaderText="CUOTA MENSUAL EN BC" SortExpression="CUOTABC" />
                    </Columns>
                ...
                <div>
                    ...
                    <asp:Button ID="obutEdita" runat="server" Text="Edita Adhesión" />
                    <br />
                    <asp:Button ID="obutAltaAdhesion" runat="server" Text="Alta nueva adhesión" />
                    <br />
                    <asp:Button ID="obutImprime" runat="server" Text="Imprime contrato de adhesion" />
                </div>
        ...
        <form class="form" role="form">
            <div class="form-group">
                ...
                <asp:SqlDataSource ID="odsBARRIO" runat="server"
                    ConnectionString="<%$ ConnectionStrings:STRSYSTEM %>"
                    SelectCommand="BARRIOIDTraerODDL" SelectCommandType="StoredProcedure">
                    <SelectParameters>
            ...
            <div class="form-group">
                <asp:Label ID="olblIDBARRIOLOTE" runat="server" Text="SELECCIONE MANZANA A CAMBIAR:" CssClass="control-label"></asp:Label>
                <br />
                <asp:DropDownList ID="oddlBarrioHabilitadoManzanaSeleccionaCambio" runat="server" AutoPostBack="True" DataSourceID="odsBarrioHabilitadoManzanaSeleccionaCambia" DataTextField="barrioManzanaDescripcion" DataValueField="idBarrioManzana" Width="100%">
                </asp:DropDownList>

                <div class="form-group">
                    <asp:Label ID="Label14" runat="server" Text="SELECCIONE LOTE A CAMBIAR:" CssClass="control-label"></asp:Label>


                    <asp:SqlDataSource ID="odsBarrioHabilitadoManzanaSeleccionaCambia" runat="server" ConnectionString="<%$ ConnectionStrings:STRSYSTEM %>" SelectCommand="barrioHabilitadoManzanaSeleccionaCambia" SelectCommandType="StoredProcedure">
                        <SelectParameters>
                            <asp:ControlParameter ControlID="oddlBarrioHabilitadoSelecciona" Name="idBarrio" PropertyName="SelectedValue" Type="Int32" />
                        </SelectParameters>
                    </asp:SqlDataSource>

                    <asp:DropDownList ID="oddlBARRIOLOTEOPERADORCAMBIA" runat="server" DataSourceID="odsBARRIOLOTEOPERADOR"
                        DataTextField="BARRIOLOTEDescripcion" DataValueField="idBARRIOLOTE" CssClass="form-control" AutoPostBack="True">
                    </asp:DropDownList>
                </div>
            ...
            <div class="form-group">
                ...
                <asp:SqlDataSource ID="odsVENDEDOR" runat="server"
                    ConnectionString="<%$ ConnectionStrings:STRSYSTEM %>"
                    SelectCommand="vendedorIDTraerODDLTodos" SelectCommandType="StoredProcedure"></asp:SqlDataSource>
            ...
            <div class="col-sm-offset-2 col-sm-10">
                ...
                <asp:Button ID="obutImagenes" runat="server" Text="Tratamiento de imagenes" CssClass="btn btn-success" />
            </div>
        </form>
