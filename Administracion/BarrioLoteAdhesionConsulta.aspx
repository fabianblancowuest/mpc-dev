        ...
        <div>
            ...
            <asp:GridView ID="ogvrptBarrioManzanaParcelaVenta" runat="server" AllowPaging="True" AllowSorting="True"
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="idLoteVenta" HeaderText="id Venta" InsertVisible="False" ReadOnly="True"
                    ...
                    <asp:BoundField DataField="idVendedor" HeaderText="idVendedor" SortExpression="idVendedor"
                        Visible="False" />
                    <asp:BoundField DataField="loteVentaFechaVisita" DataFormatString="{0:d}" HeaderText="Fecha Visita"
                        SortExpression="loteVentaFechaVisita" />
