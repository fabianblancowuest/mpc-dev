<%@ Page Title="Consulta de adhesiones por Barrio" Language="VB" MasterPageFile="~/master/p.master" AutoEventWireup="false" CodeFile="BarrioLoteAdhesionConsulta.aspx.vb" Inherits="Administracion_BarrioLoteAdhesionConsulta" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div>
            ...
            <asp:SqlDataSource ID="odsBarrioHabilitadoSelecciona" runat="server" ConnectionString="<%$ ConnectionStrings:STRSYSTEM %>" SelectCommand="barrioHabilitadoSelecciona" SelectCommandType="StoredProcedure"></asp:SqlDataSource>
...
<asp:Panel ID="PanelCadena" runat="server" Visible="false">
    ...
    <div>
        ...
        <asp:SqlDataSource ID="odsrptBarrioManzanaParcelaVenta" runat="server" ConnectionString="<%$ ConnectionStrings:STRSYSTEM %>" SelectCommand="rptBarrioManzanaParcelaVenta" SelectCommandType="StoredProcedure">
            <SelectParameters>
                <asp:ControlParameter ControlID="oddlBarrioHabilitadoSelecciona" Name="idBarrio" PropertyName="SelectedValue" Type="Int32" />
                <asp:ControlParameter ControlID="oddlBarrioHabilitadoManzanaSelecciona" Name="idBarrioManzana" PropertyName="SelectedValue" Type="Int32" />
                <asp:ControlParameter ControlID="orbOpcion" Name="tipo" PropertyName="SelectedValue" Type="String" />
                <asp:ControlParameter ControlID="otxtCadena" DefaultValue="" Name="cadenaBusqueda" PropertyName="Text" Type="String" />
            </SelectParameters>
        </asp:SqlDataSource>

        <asp:GridView ID="ogvrptBarrioManzanaParcelaVenta" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" CssClass="table-cemmi" DataSourceID="odsrptBarrioManzanaParcelaVenta" Font-Size="X-Small" PageSize="50" EmptyDataText="La consulta no ha recuperado datos con el argumento solicitado">
            <Columns>
                ...
                <asp:BoundField DataField="loteVentaAdhesionMonto" HeaderText="Monto Adhesion" SortExpression="loteVentaAdhesionMonto" />
                <asp:BoundField DataField="loteVentaCuotaMonto" HeaderText="Monto Cuota" SortExpression="loteVentaCuotaMonto" />
                <asp:BoundField DataField="cliente01Nombre" HeaderText="cliente 01 " SortExpression="cliente01Nombre" />
                <asp:BoundField DataField="cliente01DNI" HeaderText="cliente 01 DNI" SortExpression="cliente01DNI" />
                <asp:BoundField DataField="cliente01Domicilio" HeaderText="01 Domicilio" SortExpression="cliente01Domicilio" />
                <asp:BoundField DataField="cliente01Telefono" HeaderText="Telefono" SortExpression="cliente01Telefono" />
                <asp:BoundField DataField="cliente02Nombre" HeaderText="cliente02 " SortExpression="cliente02Nombre" />
                <asp:BoundField DataField="cliente02DNI" HeaderText="DNI" SortExpression="cliente02DNI" />
                <asp:BoundField DataField="cliente02Domicilio" HeaderText="02 Domicilio" SortExpression="cliente02Domicilio" />
                <asp:BoundField DataField="cliente02Telefono" HeaderText="02Telefono" SortExpression="cliente02Telefono" />
                ...
                <asp:BoundField DataField="idCuotasCantidad" HeaderText="idCuotasCantidad" SortExpression="idCuotasCantidad" Visible="False" />
                <asp:BoundField DataField="idLoteTipo" HeaderText="idLoteTipo" SortExpression="idLoteTipo" Visible="False" />
                <asp:BoundField DataField="loteVentafechaCancelacion" HeaderText="Fecha Cancelacion" SortExpression="loteVentafechaCancelacion" />
                <asp:BoundField DataField="LOTEPRECIOBC" HeaderText="LOTE PRECIO BC" SortExpression="LOTEPRECIOBC" />
                <asp:BoundField DataField="CUOTABC" HeaderText="CUOTA BC" SortExpression="CUOTABC" />
                <asp:BoundField DataField="clienteIVaDescripcion" HeaderText="IVA Cliente" SortExpression="clienteIVaDescripcion" />
                ...
                <asp:BoundField DataField="EstadoImpresion" HeaderText="Impreso" ReadOnly="True" SortExpression="EstadoImpresion" />
            </Columns>
        </asp:GridView>
