<%@ Page Language="VB" MasterPageFile="~/master/p.master" AutoEventWireup="false" CodeFile="BARRIOMANZANA.aspx.vb" Inherits="STRSYSTEM_Administracion_BARRIOMANZANA" title="Tratamiento Tabla MANZANAS EN BARRIOS" Culture="es-AR"                             %> 
...
<div>
              ...
              <asp:SqlDataSource ID="odsBARRIOMANZANA" runat="server"   
                  ConnectionString="<%$ ConnectionStrings:STRSYSTEM %>"  
                  SelectCommand="BARRIOMANZANATRAERID" SelectCommandType="StoredProcedure">          
                <SelectParameters>
               <asp:ControlParameter ControlID="oddlBARRIOOperador" Name="idBARRIO" PropertyName="SelectedValue" Type="Int16"  />    
               </SelectParameters>
              </asp:SqlDataSource>
<div class="table-responsive">
             <asp:GridView ID="ogvBARRIOMANZANA" runat="server" AutoGenerateColumns="False"  CssClass="table-cemmi" AlternatingRowStyle-CssClass="alt" AllowPaging="False" PageSize="15" PagerStyle-CssClass="pgr"          
               ...
               <asp:CommandField ShowSelectButton="True" SelectText="Seleccione"> 
                     ...
                     <asp:BoundField DataField="IDBARRIOMANZANA" HeaderText="id"    
                     ...
                     <asp:BoundField DataField="IDBARRIOMANZANASTATUS" HeaderText="STATUS"        
                        InsertVisible="False" ReadOnly="True" visible="False" 
                        SortExpression="IDBARRIOMANZANASTATUS"/> 
                   <asp:TemplateField HeaderText="ESTADO"  SortExpression="BARRIOMANZANAESTADO" >       
                     <ItemTemplate>
                     <asp:CheckBox ID="BARRIOMANZANAESTADOBox"  runat="server" Checked='<% # Bind("BARRIOMANZANAESTADO") %>' Enabled="false"  />             
                   </ItemTemplate>
     ...
     <ItemStyle HorizontalAlign="Right" />
                     ...
                     <asp:BoundField DataField="BARRIOMANZANABONIFICACION" HeaderText="BONIFICACION POR COMPRA CONTADO"                 
     SortExpression="BARRIOMANZANABONIFICACION">        
     <ItemStyle HorizontalAlign="Right" />
     </asp:BoundField>
                   <asp:TemplateField HeaderText="ES LOTEABLE ?"  SortExpression="BARRIOMANZANALOTEABLE" >        
                     <ItemTemplate>
                     <asp:CheckBox ID="BARRIOMANZANALOTEABLEBox"  runat="server" Checked='<% # Bind("BARRIOMANZANALOTEABLE") %>' Enabled="false"  />             
                   </ItemTemplate>
                  <ItemStyle HorizontalAlign="Center" />
                </asp:TemplateField>
               </Columns>
...
<div class="form-group">
<asp:Label ID="olblBARRIOMANZANACODIGO" runat="server" Text="CODIGO MANZANA:" CssClass="control-label"></asp:Label>             
         <asp:TextBox ID="otxtBARRIOMANZANACODIGO" runat="server" CssClass="form-control" MaxLength="50"></asp:TextBox>         
</div>
<div class="form-group">
<asp:Label ID="olblBARRIOMANZANADESCRIPCION" runat="server" Text="DESCRIPCION MANZANA:" CssClass="control-label"></asp:Label>               
         <asp:TextBox ID="otxtBARRIOMANZANADESCRIPCION" runat="server" CssClass="form-control" MaxLength="150"></asp:TextBox>          
</div>
<div class="form-group">
<asp:Label ID="olblBARRIOMANZANAEXPLICACION" runat="server" Text="EXPLICACION MANZANA:" CssClass="control-label"></asp:Label>              
         <asp:TextBox ID="otxtBARRIOMANZANAEXPLICACION" runat="server" CssClass="form-control" TextMode="MultiLine" height="500px" ></asp:TextBox>         
</div>
<div class="form-group">
<asp:Label ID="olblIDBARRIOMANZANASTATUS" runat="server" Text="STATUS:" CssClass="control-label"></asp:Label>         
                         <asp:SqlDataSource ID="odsBARRIOMANZANASTATUS" runat="server"          
                ConnectionString="<%$ ConnectionStrings:STRSYSTEM %>"   
                SelectCommand="BARRIOMANZANASTATUSTraerOddl" SelectCommandType="StoredProcedure"></asp:SqlDataSource>             
                        <asp:DropDownList ID="oddlBARRIOMANZANASTATUS" runat="server" DataSourceID="odsBARRIOMANZANASTATUS"           
                DataTextField="BARRIOMANZANASTATUSDescripcion" DataValueField="IDBARRIOMANZANASTATUS" CssClass="form-control">            
            </asp:DropDownList> 
</div>
<div class="form-group">
<asp:Label ID="olblBARRIOMANZANAESTADO" runat="server" Text="ESTADO:" CssClass="control-label"></asp:Label>          
      <asp:CheckBox ID="otxtBARRIOMANZANAESTADO" runat="server"  />       
</div>
<div class="form-group">
<asp:Label ID="olblBARRIOMANZANAPRECIOBC" runat="server" Text="PRECIO BC:" CssClass="control-label"></asp:Label>           
         <asp:TextBox ID="otxtBARRIOMANZANAPRECIOBC" runat="server" CssClass="form-control" MaxLength="17"></asp:TextBox>          
</div>
<div class="form-group">
<asp:Label ID="olblBARRIOMANZANABONIFICACION" runat="server" Text="BONIFICACION POR COMPRA CONTADO:" CssClass="control-label"></asp:Label>                   
         <asp:TextBox ID="otxtBARRIOMANZANABONIFICACION" runat="server" CssClass="form-control" MaxLength="17"></asp:TextBox>          
</div>
<div class="form-group">
<asp:Label ID="olblBARRIOMANZANALOTEABLE" runat="server" Text="ES LOTEABLE ?:" CssClass="control-label"></asp:Label>            
