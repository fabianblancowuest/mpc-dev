...
Partial Class Administracion_comprobantePagoGar
    Inherits System.Web.UI.Page



    Protected Sub Page_Load(sender As Object, e As EventArgs) Handles Me.Load
        olblComprobanteNumero.Text = Session("idAsientoCabecera").text

        asientoCabeceraExplicacionTrae()
        cargarDatos()
    End Sub

    Private Sub asientoCabeceraExplicacionTrae()
        ...
        Using connection As New System.Data.SqlClient.SqlConnection(connectionString)
            With cmd
                ...
                .CommandText = "asientoCabeceraExplicacionTrae"
            ...
            Try
                ...
                If reader.HasRows Then
                    While reader.Read
                        olblAsientoCabeceraExplicacion.Text = reader.Item("asientoCabeceraExplicacion")
            ...
            Catch ex As Exception
                olblAsientoCabeceraExplicacion.Text = ex.Message
