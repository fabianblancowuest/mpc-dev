<%@ Page Language="VB" AutoEventWireup="false" MaintainScrollPositionOnPostback ="true" CodeFile="ACCESOFUERADESESION.aspx.vb" Inherits=" GPS_CERTIFICACION_ADMINISTRACION_accesoFueraDeSesion" %>
            ...
            <asp:Panel ID="Panel1" runat="server">
	            <div class="acceso-fuera-sesion login">
                    <div class="acceso-fuera-sesion-box">
                        <h2 class="panel-heading mensaje-sin-sesion">Se ha perdido la sesión. Puede haber pasado un tiempo desde que no se opera el sistema. Debe ingresar nuevamente</h2>
			            <div class="panel-body">
                            <div class="usuario-fuera-sesion">
					            <p>Usuario fuera de Sesión</p>
                                <p>Por favor, reingrese al sistema para seguir operando.</p>
                                    <asp:Button ID="obutReingresar" runat="server" Text="Reingresar al Sistema" CssClass="btn-basic btn btn-primary d-block my-4" />
                                    <asp:Label ID="olblObservacion" runat="server" Text="Haga click en el botón 'Reingresar al Sistema'. Será necesario reintroducir sus credenciales."  ></asp:Label>
                                </div>
