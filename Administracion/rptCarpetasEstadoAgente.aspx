<%@ Page Title="Carpetas pendientes de firma por parte de Agente Inmobiliario" Language="VB" MasterPageFile="~/master/p.master" AutoEventWireup="false" CodeFile="rptCarpetasEstadoAgente.aspx.vb" Inherits="Administracion_rptCarpetasEstadoAgente" %>
...
<div>
    <h2 class="titulo-rol">
        <asp:Label ID="olblTitulo" runat="server" Text="Reporte de carpetas pendientes de firma por parte de agente inmobiliario"></asp:Label>
...
<div>
    <asp:SqlDataSource ID="odsrptCarpetasEstadoEntreTres" runat="server" ConnectionString="<%$ ConnectionStrings:STRSYSTEM %>" SelectCommand="rptCarpetasEstadoAgente" SelectCommandType="StoredProcedure">
        <SelectParameters>
