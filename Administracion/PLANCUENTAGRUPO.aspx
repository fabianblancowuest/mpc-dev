...
<%@ Page Language="VB" MasterPageFile="~/master/p.master" AutoEventWireup="false" CodeFile="PLANCUENTAGRUPO.aspx.vb" Inherits="STRSYSTEM_Administracion_PLANCUENTAGRUPO" title="Tratamiento Tabla MANTENIMIENTO DE GRUPOS DE
...
<asp:Label ID="olblPLANCUENTAGRUPOTitulo" runat="server" Text="MANTENIMIENTO DE GRUPOS DE CUENTAS CONTABLES"></asp:Label>                      
      </h2>
    </div>
 </asp:Panel> 
        ...
        <asp:Panel ID="Panel1" runat="server">
         ...
         <div class="row contenedor-flexible margenes-y">
              ...
              <asp:SqlDataSource ID="odsPLANCUENTAGRUPO" runat="server"     
                  ...
                  SelectCommand="PLANCUENTAGRUPOTRAERCADENA" SelectCommandType="StoredProcedure">              
                  <SelectParameters>
                   <asp:ControlParameter ControlID="otxtCadena" Name="cadena" PropertyName="Text" Type="String" />
                  </SelectParameters>
              </asp:SqlDataSource>
<div class="table-responsive">
             <asp:GridView ID="ogvPLANCUENTAGRUPO" runat="server" AutoGenerateColumns="False"  CssClass="table-cemmi" AlternatingRowStyle-CssClass="alt" AllowPaging="True" PageSize="15" PagerStyle-CssClass="pgr"            
               ...
               <asp:CommandField ShowSelectButton="True" SelectText="Seleccione"> 
                     ...
                     <asp:BoundField DataField="IDPLANCUENTAGRUPO" HeaderText="ID"     
                        InsertVisible="False" ReadOnly="True" visible="False" 
                        SortExpression="IDPLANCUENTAGRUPO"/>
                   ...
                   <asp:TemplateField HeaderText="ESTADO DE GRUPO"  SortExpression="PLANCUENTAGRUPOESTADO" >            
                     <ItemTemplate>
                     <asp:CheckBox ID="PLANCUENTAGRUPOESTADOBox"  runat="server" Checked='<% # Bind("PLANCUENTAGRUPOESTADO") %>' Enabled="false"  />                
                   </ItemTemplate>
...
<div class="form-group">
<asp:Label ID="olblPLANCUENTAGRUPOCODIGO" runat="server" Text="CODIGO DE GRUPO:" CssClass="control-label"></asp:Label>              
         <asp:TextBox ID="otxtPLANCUENTAGRUPOCODIGO" runat="server" CssClass="form-control" MaxLength="20"></asp:TextBox>           
</div>
<div class="form-group">
<asp:Label ID="olblPLANCUENTAGRUPODESCRIPCION" runat="server" Text="DESCRIPCION DE GRUPO:" CssClass="control-label"></asp:Label>                 
         <asp:TextBox ID="otxtPLANCUENTAGRUPODESCRIPCION" runat="server" CssClass="form-control" MaxLength="100"></asp:TextBox>            
</div>
<div class="form-group">
<asp:Label ID="olblPLANCUENTAGRUPOESTADO" runat="server" Text="ESTADO DE GRUPO:" CssClass="control-label"></asp:Label>               
