...
Partial Class Administracion_operadorVentaTalonPromo
    ...
    Private Sub talonVendedorAsientaPremio()
                ...
                Try
                    ...
                    If reader.HasRows Then
                        While reader.Read
                            ...
                            olblpremioMayorBilleteCantidad.Text = reader.Item("premioMayorBilleteCantidad")
                            olbpromocionBilleteCantidad.Text = reader.Item("promocionBilleteCantidad")
                            olblCantidadPromocionado.Text = reader.Item("promocionBilleteCantidad")
                            If reader.Item("premioValido") > 0 Then
        ...
        ogvOperadorBilleteObsequio.DataBind()
        odsSorteoTalonDisponibleVendedor.DataBind()

        ogvSorteoVendedorTalonSeleccionado.DataBind()
        ogvSorteoVendedorTalonSeleccionadoPromo.DataBind()
    ...
    Private Sub talonVendedorAsientaPromo()
        ...
        Dim id As Label
        Dim idSorteoTalon As DropDownList
        ...
        Using connection As New System.Data.SqlClient.SqlConnection(connectionString)
            With cmd
                .Connection = connection
                .CommandType = Data.CommandType.StoredProcedure
                .CommandText = "sorteoTalonVendedorAsientaPromo"
            End With
               For Each Row In ogvOperadorBilleteObsequio.Rows
                Try
                    cmd.Parameters.Clear()
                    ...
                    idSorteoTalon = CType(Row.FindControl("oddlBonoLibreOperador"), DropDownList)
                    connection.Open()

                    cmd.Parameters.Add("@id", Data.SqlDbType.Int).SqlValue = id.Text
                    cmd.Parameters.Add("@idSorteoTalon", Data.SqlDbType.Int).SqlValue = idSorteoTalon.SelectedValue.ToString
                    cmd.Parameters.Add("@sorteoTalonSession", Data.SqlDbType.Char).SqlValue = Session.SessionID
                    ...
                    End If
                Catch ex As Exception
                    olblValidacionMensajeErrorPremio.Text = LTrim(RTrim(olblValidacionMensajeErrorPremio.Text)) + " Error: " + ex.ToString + "  Error " + idSorteoTalon.SelectedValue.ToString
    ...
    Private Sub talonVendedorAsientaClientePromo()
        ...
        Using connection As New System.Data.SqlClient.SqlConnection(connectionString)
            ...
            olblMontoTotal.Text = "0"
            olblCantidadTotal.Text = "0"
            For Each Row In ogvSorteoVendedorTalonSeleccionadoPromo.Rows
                Try
                    cmd.Parameters.Clear()
    ...
    Protected Sub orbValores_SelectedIndexChanged(sender As Object, e As EventArgs) Handles orbValores.SelectedIndexChanged
        PanelAlta.Visible = True

        obutValoresComplementar.Visible = False

        If orbValores.SelectedValue = "1" Then
            ...
            otxtValorTransferenciaMonto.Text = "0"
            otxtValorTransferenciaMonto.Enabled = False

            otxtValorTransferenciaNumero.Text = ""
            otxtValorTransferenciaNumero.Enabled = False

        End If

        If orbValores.SelectedValue = "2" Then
        ...
        If orbValores.SelectedValue = "3" Then
            obutValoresComplementar.Visible = True

            PanelEfectivo.Visible = True
            PanelTransferencia.Visible = True
            otxtValorEfectivoMonto.Text = olblMontoTotal.Text
            otxtValorEfectivoMonto.Enabled = True
            otxtValorTransferenciaMonto.Text = "0"
            otxtValorTransferenciaMonto.Enabled = False
            otxtValorTransferenciaNumero.Enabled = True
        End If
    ...
    Private Sub subirImagen()
        ...
        If FileUpLoad2.HasFile Then
            ...
            Else
                ...
                FileUpLoad2.SaveAs("C:\inetpub\sites\mpc\talones\" & nombreArchivo + extension)
                ...
                olblPrevisualiza.Text = "~/talones/" + nombreArchivo + extension
                olblPrevisualiza.Visible = True

                ' grabarURL()

                Image1.ImageUrl = "~/talones/" + nombreArchivo + extension
                Label11.Text = "https://www.miprimercasa.ar/talones/" + nombreArchivo + extension
    ...
    Protected Sub ventaConfirmada()
        ...
        talonVendedorAsientaClientePromo()
    ...
    Private Sub inicializaVariables()
        ...
        obutOperacionRealizada.Visible = False
    ...
    Private Sub mensajeswhatapp()
        ...
        Using connection As New System.Data.SqlClient.SqlConnection(connectionString)
            With cmd
                .Connection = connection
                .CommandType = Data.CommandType.StoredProcedure
                .CommandText = "sorteoTalonCobranzaWhatsappNotifica"
