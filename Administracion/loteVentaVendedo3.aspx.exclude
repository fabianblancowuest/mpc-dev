<%@ Page Language="VB" MasterPageFile="~/master/p.master" MaintainScrollPositionOnPostback="true" AutoEventWireup="false" CodeFile="loteVentaVendedo3.aspx.vb" Inherits="STRSYSTEM_Administracion_LOTEVENTAVENDEDO3" Title="Tratamiento de venta de lotes por vendedor" Culture="es-AR" %>
            ...
            <div class="table-responsive">
                <asp:GridView ID="ogvLOTEVENTA" runat="server" AutoGenerateColumns="False" CssClass="table-cemmi" AlternatingRowStyle-CssClass="alt" AllowPaging="True" PageSize="15" PagerStyle-CssClass="pgr"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="barrioLoteEstado" HeaderText="Estado de Lote" SortExpression="barrioLoteEstado" />
