...
Partial Class Administracion_SORTEOSUPERVISORASIGNAVENDEDORMANUAL
    ...
    Private Sub numerar()
        ...
        olblRangoHasta.Text = olblAsignaHasta.Text
        olblIdSorteoTalonario.Text = "1"
    ...
    Protected Sub obutAsignar_Click(sender As Object, e As EventArgs) Handles obutAsignar.Click
        ...
        If olblGestionCodigo.Text = "1" Then
            Response.Redirect("SORTEOSUPERVISORASIGNAVENDEDORMANUAL.ASPX")
        End If
    End Sub
