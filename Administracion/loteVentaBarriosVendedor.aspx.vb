Imports STRSYSTEM
Partial Class STRSYSTEM_Administracion_LOTEVENTABARRIOSVENDEDOR
    ...
    Protected Sub obutAlta_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles obutAlta.Click
        ...
        obutDocumentacion.Visible = False
        obutReciboCajaFirmado.Visible = False
    ...
    Protected Sub ogvLOTEVENTA_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles ogvLOTEVENTA.SelectedIndexChanged
        ...
        obutDocumentacion.Visible = True
        obutReciboCajaFirmado.Visible = True
    ...
    Protected Sub obutDocumentacionVolver_Click(sender As Object, e As EventArgs) Handles obutDocumentacionVolver.Click
        ...
        PanelReciboCaja.Visible = False

    End Sub

    Protected Sub obutDocumentacion_Click(sender As Object, e As EventArgs) Handles obutDocumentacion.Click
        documentacion()

    End Sub
    Private Sub reciboDuplicadoCaja()
        Panel1.Visible = False
        PanelAlta.Visible = False
        PanelDocumentacion.Visible = False
        PanelReciboCaja.Visible = True
      
        reciboDuplicadoCaja01.inicializa(olblIDLOTEVENTA, "12", olblCLIENTE01NOMBRE, "1")
        reciboDuplicadoCaja02.inicializa(olblIDLOTEVENTA, "13", olblCLIENTE01NOMBRE, "2")
        reciboDuplicadoCaja03.inicializa(olblIDLOTEVENTA, "14", olblCLIENTE01NOMBRE, "1")
        reciboDuplicadoCaja04.inicializa(olblIDLOTEVENTA, "15", olblCLIENTE01NOMBRE, "2")
      
    End Sub

    Protected Sub obutReciboCajaFirmado_Click(sender As Object, e As EventArgs) Handles obutReciboCajaFirmado.Click
        reciboDuplicadoCaja()

    End Sub

    Protected Sub obutReciboCajaVolver_Click(sender As Object, e As EventArgs) Handles obutReciboCajaVolver.Click
        Panel1.Visible = True
        PanelAlta.Visible = False
        PanelDocumentacion.Visible = False
        PanelReciboCaja.Visible = False
