<%@ Control Language="VB"  AutoEventWireup="false" CodeFile="loteDocumentacionBlanco.ascx.vb" Inherits="ventaWEB_loteDocumentacionBlanco" %>
...
<div>
    ...
    <br />
    <asp:Button ID="UploadBtn" Text="Subir Imagen" Height ="100px" Width ="200px" OnClick="UploadBtn_Click" runat="server" CssClass="sdsasdasd" />
        <br /> <br /> <br />                
</div>
