...
Partial Class ventaWEB_webVentaTalon2

    Inherits System.Web.UI.Page
    Protected Sub Page_Load(sender As Object, e As EventArgs) Handles Me.Load
        If IsPostBack Then
        Else
            oparCorreo.Text = Request.QueryString("email")
            oparCelular.Text = Request.QueryString("first_name")
            olblIdSorteo.Text = 1
    ...
    Public Sub subirImagen()
        ...
        If FileUpLoad2.HasFile Then
            ...
            Else
                ...
                nombreArchivo = Right("000000" + LTrim(RTrim(olblIdSorteoTalonCobranza.Text)), 6) + Right("00000" + LTrim(RTrim(olblidImagenTipo.Text)), 5).Replace(" ", "_")
        ...
        Using connection As New System.Data.SqlClient.SqlConnection(connectionString)
            ...
            For Each Row In ogvSorteoVendedorTalonSeleccionado.Rows
                Try
                    ...
                    cmd.Parameters.Add("@clienteCorreoElectronico", Data.SqlDbType.Text).SqlValue = " Venta WEB por Celular"
    ...
    Protected Sub obutOpcionPagoConMercadoPago_Click(sender As Object, e As EventArgs) Handles obutOpcionPagoConMercadoPago.Click
        Image1.ImageUrl = "https://www.miprimercasa.ar/talonesWEB/mercadoPagoImagenPendiente.jpg"
    ...
    Protected Sub obutTransferenciaAMercadoPago_Click(sender As Object, e As EventArgs) Handles obutTransferenciaAMercadoPago.Click
        ...
        Image1.ImageUrl = "https://www.miprimercasa.ar/talonesWEB/transferenciaImagenPendiente.jpg"
