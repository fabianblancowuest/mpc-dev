<%@ Page Language="VB" AutoEventWireup="false" CodeFile="login.aspx.vb" Inherits="administracion_login" %>
	...
	<body>
									...
									<div class="panel-body login">
										...
										<div class="row">
											<div class="form-group">
												<asp:Label ID="olblUsuario" runat="server" Text="Ingrese Usuario">
												</asp:Label>
												<asp:TextBox ID="otxtUsuario" runat="server"
											...
											<div class="form-group">
												<asp:Label ID="olblPass" runat="server" Text="Ingrese Contraseña:">
												</asp:Label>
												<asp:TextBox ID="otxtPass" runat="server"
										...
										<div class="row">
											<asp:Button ID="obutIngresar" runat="server" Text="Ingresar al Sistema"
												CssClass="btn btn-primary" />
											<br />
											<a href="passRecover.aspx">¿Perdió su contraseña?</a>
											<br />
											<asp:Label ID="olblObservacion" runat="server"
												Text="Ingrese usuario y contraseña y luego presione el botón Ingresar al Sistema"
		...
		<script>
			...
			// const ingresarIco = document.createElement("i");
			// ingresarIco.classList("bi", "bi-box-arrow-in-right");

			// document.getElementById("obutIngresar").append(ingresarIco);
		</script>
