<%@ Control Language="VB" AutoEventWireup="false" CodeFile="tesoreriaCobranza.ascx.vb" Inherits="sitioWEB_tesoreriaCobranza" %>
        <div>
            <!-- session("idOperador") -->
            ...
            <asp:Panel ID="PanelValores" runat="server">
                ...
                <div>
                    <asp:Label ID="olblMontoLeyenda" runat="server" Text="Total a cobrar:" Font-Bold="True" Width="10%"></asp:Label>
                    <asp:TextBox ID="otxtMontoImporte" runat="server" Text="79237.12" Font-Bold="true" Enabled="false" Width="10%"></asp:TextBox>
                ...
                <div>
                    <asp:Panel ID="PanelCobranzaExceso" runat="server" Visible="false">
                        ...
                        <div>
                            <asp:Label ID="Label4" runat="server" Text="Dinero a favor cliente:" Width="10%"></asp:Label>
                        ...
                        <div>
                            <asp:Button ID="obutAfirmaSaldoACuenta" runat="server" Text="Saldo a cuenta del cliente" />
                ...
                <asp:SqlDataSource ID="odsTesoreriaValoresInicia" runat="server" ConnectionString="<%$ ConnectionStrings:STRSYSTEM %>" SelectCommand="tesoreriaCobranzaOperador" SelectCommandType="StoredProcedure">
                    <SelectParameters>
                        <asp:SessionParameter DefaultValue="1" Name="idOperador" SessionField="idOperador" Type="Int32" />
