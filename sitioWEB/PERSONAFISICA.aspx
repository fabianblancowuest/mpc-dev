<%@ Page Language="VB" MasterPageFile="~/master/p.master" AutoEventWireup="false" CodeFile="PERSONAFISICA.aspx.vb" Inherits="STRSYSTEM_Administracion_PERSONAFISICA" title="Tratamiento Tabla MANTENIMIENTO DE PERSONAS FÌSICAS"                             %> 
...
<asp:Label ID="olblPERSONAFISICATitulo" runat="server" Text="MANTENIMIENTO DE PERSONAS FÌSICAS"></asp:Label>              
      </h1>
    </div>
 </asp:Panel> 
